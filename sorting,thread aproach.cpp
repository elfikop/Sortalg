...
int main() {
    int choice;
    cout<<"MENU OPCJI"<<endl<<"Naciœnij 0, aby rozpoczac pomiar"<<endl;
    cin>>choice;
        int c=0;
        ofstream plik("newrand10-110.txt", std::ios::out | std::ios::trunc );
        for(int n=10000;n<=110000;n=n+100000){
            a=n;
            for(int i=1;i<=100;i++){
                czas++;
                randomize(a);
